...
#ifndef SM_LAYERS_CYR_WIN_SYMBOLS_ENABLED
#define SM_LAYERS_CYR_WIN_SYMBOLS_SIZE 0
#define SM_LAYERS_CYR_WIN_SYMBOLS_KEYCODES
#else
#define SM_LAYERS_CYR_WIN_SYMBOLS_SIZE 12
#define SM_LAYERS_CYR_WIN_SYMBOLS_KEYCODES \
   CYR_W1, CYR_W2, CYR_W3, CYR_W4, CYR_W5, CYR_W6, CYR_W7, CYR_W8, CYR_W9, CYR_W0, CYR_WDOT, CYR_WSLASH,
#endif


#ifndef SM_LAYERS_CYR_MAC_SYMBOLS_ENABLED
#define SM_LAYERS_CYR_MAC_SYMBOLS_SIZE 0
#define SM_LAYERS_CYR_MAC_SYMBOLS_KEYCODES
#else
#define SM_LAYERS_CYR_MAC_SYMBOLS_SIZE 12
#define SM_LAYERS_CYR_MAC_SYMBOLS_KEYCODES \
   CYR_M1, CYR_M2, CYR_M3, CYR_M4, CYR_M5, CYR_M6, CYR_M7, CYR_M8, CYR_M9, CYR_M0, CYR_MSLASH, CYR_MBRC,
#endif


#define SM_LAYERS_SIZE (SM_LAYERS_CYR_SIZE + SM_LAYERS_CYR_WIN_SYMBOLS_SIZE + SM_LAYERS_CYR_MAC_SYMBOLS_SIZE)

#define SM_LAYERS_KEYCODES            \
   SM_LAYERS_BEGIN,                   \
   SM_LAYERS_CYR_KEYCODES             \
   SM_LAYERS_CYR_WIN_SYMBOLS_KEYCODES \
   SM_LAYERS_CYR_MAC_SYMBOLS_KEYCODES \
   SM_LAYERS_END                      \
