...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 CKC_CYR_YY, CKC_CYR_F,CKC_CYR_YI, CKC_CYR_V, CKC_CYR_A, CKC_CYR_P,        CKC_CYR_R, CKC_CYR_O, CKC_CYR_L, CKC_CYR_D,CKC_CYR_ZH,    CYR_YE,
  ...
  [L_NUM] = LAYOUT_voyager(
    ...
    IIIIIII,  KC_DOT,     KC_4,     KC_5,     KC_6,  KC_CIRC,          KC_RCMD,    KC_AT,  KC_HASH,   KC_ROPT,   KC_RCMD,   IIIIIII,
  ...
  [L_FN] = LAYOUT_voyager(
    ...
    IIIIIII,   KC_LGUI,    KC_F4,     KC_F5,   KC_F6,   KC_F11,         KC_LEFT,  KC_DOWN,    KC_UP, KC_RIGHT,  KC_VOLU,   IIIIIII,
    IIIIIII,    M_SCRN,     KC_F1,      KC_F2,    KC_F3,    KC_F12,          KC_HOME,   KC_PGDN,   KC_PGUP,    KC_END,   KC_VOLD,   IIIIIII,
      ___  ,     ___  ,     ___  ,     ___  ,     ___  ,    KC_TAB,          IIIIIII,     ___  ,     ___  ,     ___  ,     ___  ,     ___  ,
                                              KC_SPACE, KC_ENTER,          KC_ESC,   KC_TAB
  ),

  // Fake layer to store CYR_F, CYR_YI and others positions. There are KC_CYR_* in L_RU, and they are not handled properly by sm_layouts
