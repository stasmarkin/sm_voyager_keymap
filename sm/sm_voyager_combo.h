...
// Machine-local combos live in sm_secrets.h, which is kept out of git. Absent
// that file every hook below expands to nothing: no enum entries, no key
// definitions, no handlers — so a public checkout reveals neither what they
// type nor which keys trigger them.
#if __has_include("sm_secrets.h")
#    include "sm_secrets.h"
#endif

#ifndef SM_SECRETS_COMBO_ENUM
#    define SM_SECRETS_COMBO_ENUM
#endif
#ifndef SM_SECRETS_COMBO_DEFS
#    define SM_SECRETS_COMBO_DEFS
#endif
#ifndef SM_SECRETS_COMBO_ENTRIES
#    define SM_SECRETS_COMBO_ENTRIES
#endif
#ifndef SM_SECRETS_COMBO_CASES
#    define SM_SECRETS_COMBO_CASES
#endif
...
enum combo_events {
    ...
    // Kept last so the public indices above stay the same whether or not
    // sm_secrets.h is present.
    SM_SECRETS_COMBO_ENUM
};
...
const uint16_t PROGMEM combo_MPQ_RU[]      = {CKC_CYR_SFT_SLD, CYR_ZZ, CYR_YY, COMBO_END};
...
const uint16_t PROGMEM combo_ASF[]  = {KC_A, KC_S, KC_F, COMBO_END};
...
const uint16_t PROGMEM combo_ZX[]   = {M_EMPTY3, KC_X, COMBO_END};
const uint16_t PROGMEM combo_WE[]   = {KC_W, KC_E, COMBO_END};
const uint16_t PROGMEM combo_WR[]   = {KC_W, KC_R, COMBO_END};
const uint16_t PROGMEM combo_SE[]   = {KC_S, KC_E, COMBO_END};
...
const uint16_t PROGMEM combo_DR[]   = {KC_D, KC_R, COMBO_END};
...
const uint16_t PROGMEM combo_IL[]   = {KC_I, KC_L, COMBO_END};
...
const uint16_t PROGMEM combo_OZ[]   = {KC_O, KC_Z, COMBO_END};
const uint16_t PROGMEM combo_LDOT[] = {KC_L, KC_Z, COMBO_END};
const uint16_t PROGMEM combo_QQUE[] = {KC_Q, M_QUE, COMBO_END};
const uint16_t PROGMEM combo_DK[]   = {KC_D, KC_K, COMBO_END};

const uint16_t PROGMEM combo_AW_RU[]   = {CKC_CYR_F, CYR_CC, COMBO_END};
const uint16_t PROGMEM combo_ZX_RU[]   = {CYR_ZH, CYR_CH, COMBO_END};
...
const uint16_t PROGMEM combo_MK_RU[]   = {CKC_CYR_SFT_SLD, CKC_CYR_L, COMBO_END};
const uint16_t PROGMEM combo_MP_RU[]   = {CKC_CYR_SFT_SLD, CYR_ZZ, COMBO_END};
const uint16_t PROGMEM combo_MQ_RU[]   = {CKC_CYR_SFT_SLD, CYR_YY, COMBO_END};
...
const uint16_t PROGMEM combo_KQ_RU[]   = {CKC_CYR_L, CYR_YY, COMBO_END};
const uint16_t PROGMEM combo_PQ_RU[]   = {CYR_ZZ, CYR_YY, COMBO_END};
const uint16_t PROGMEM combo_OZ_RU[]   = {CYR_SCH, CKC_CYR_YA_YE, COMBO_END};
const uint16_t PROGMEM combo_LDOT_RU[] = {CKC_CYR_D, CKC_CYR_YA_YE, COMBO_END};
const uint16_t PROGMEM combo_QQUE_RU[] = {CYR_YY, CYR_H, COMBO_END};
const uint16_t PROGMEM combo_DK_RU[]   = {CKC_CYR_V, CKC_CYR_L, COMBO_END};

const uint16_t PROGMEM combo_AW_NUM[] = {KC_DOT, KC_7, COMBO_END};
...
const uint16_t PROGMEM combo_SE_NUM[] = {KC_4, KC_8, COMBO_END};
const uint16_t PROGMEM combo_SC_NUM[] = {KC_4, KC_2, COMBO_END};
const uint16_t PROGMEM combo_XC_NUM[] = {KC_1, KC_2, COMBO_END};
const uint16_t PROGMEM combo_XD_NUM[] = {KC_1, KC_5, COMBO_END};
const uint16_t PROGMEM combo_ER_NUM[] = {KC_8, KC_9, COMBO_END};
const uint16_t PROGMEM combo_EF_NUM[] = {KC_8, KC_6, COMBO_END};
const uint16_t PROGMEM combo_DR_NUM[] = {KC_5, KC_9, COMBO_END};
const uint16_t PROGMEM combo_DF_NUM[] = {KC_5, KC_6, COMBO_END};
const uint16_t PROGMEM combo_DV_NUM[] = {KC_5, KC_3, COMBO_END};
const uint16_t PROGMEM combo_CV_NUM[] = {KC_2, KC_3, COMBO_END};

SM_SECRETS_COMBO_DEFS
...
void process_combo_event(uint16_t combo_index, bool pressed) {
    switch (combo_index) {
        ...
        case ERUI_GAMING: {
            ...
            layer_move(L_EN);
            tap_code16(LCMD(LCTL(LOPT(LSFT(KC_F9)))));
            return;
        }
